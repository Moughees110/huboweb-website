    ...
    <main className="relative min-h-screen text-white bg-transparent">
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        ...
        <p className="mb-6 leading-relaxed text-gray-300">
          Akhter Hussain is an accomplished business strategist and operations
          leader. With over a decade of experience in management consulting and
          corporate development, Akhter brings deep insight into business
          transformation.
        </p>
        <p className="mb-6 leading-relaxed text-gray-300">
          Known for his analytical mindset and people-first leadership, Akhter
        ...
        <p className="leading-relaxed text-gray-300">
          When not immersed in strategy sessions, Akhter enjoys hiking, reading
