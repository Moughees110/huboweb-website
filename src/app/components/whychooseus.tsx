...
const reasons = [
  {
    ...
    description: "We build fast-loading websites optimized for speed and performance.",
    icon: <Rocket className="h-8 w-8 text-yellow-400" />,
  },
  {
    title: "Clean & Scalable Code",
    description: "Maintainable code structure built with modern frameworks and best practices.",
    icon: <Code className="h-8 w-8 text-yellow-400" />,
  },
  {
    title: "Reliable & Secure",
    description: "Security is baked into our development process from the start.",
    icon: <ShieldCheck className="h-8 w-8 text-yellow-400" />,
  },
  {
    title: "On-Time Delivery",
    description: "We respect timelines and deliver high-quality work within deadline.",
  ...
  },
  {
    ...
    description: "We align our design and code to help your business grow online.",
    ...
    <section className="w-full bg-gradient-to-r from-[#070121] to-gray-900 text-white py-20 px-4 md:px-10">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-300 max-w-2xl mx-auto">
          We don’t just build websites — we build solutions that work for your business and your users.
        </p>
      </div>
