...
export default function ServicesSection() {
  return (
    <section className="w-full bg-gradient-to-r from-[#070121] to-gray-900 text-white py-20">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-6 md:px-10 gap-12">
        ...
        <div className="w-full md:w-1/2 space-y-6">
          ...
          <p className="text-gray-300 text-lg">
            All our WordPress themes are built using Elementor, the world’s leading
            WordPress page builder. It empowers you to create stunning websites
            effortlessly, with no coding required. Experience unmatched flexibility,
            speed, and a user-friendly drag-and-drop interface that makes web
            design a breeze.
          </p>
