...
import { Workflow, Bot, DatabaseZap, UserCheck, ShieldCheck, Zap, Star } from "lucide-react";
    ...
    <section className="w-full bg-[#0a0f24] text-white px-6 md:px-16 py-20 space-y-28">
      ...
      <div className="bg-gradient-to-r from-[#0e162e] to-[#1f2a48] rounded-2xl p-10 shadow-xl">
        ...
        <p className="text-lg text-gray-300 max-w-5xl mb-6">
          In today's digital landscape, manually managing customer relationships is inefficient and risky. CRM Automation streamlines your workflow, ensures data accuracy, boosts productivity, and enhances customer satisfaction. Our custom CRM solutions are tailored to automate sales pipelines, customer communication, lead tracking, and more — allowing your team to focus on what matters most: growing your business.
        </p>
      ...
      {/* What We Automate */}
      <div>
        <h2 className="text-4xl md:text-5xl font-extrabold text-yellow-400 mb-10">
          What We Automate
        </h2>
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
          {[
            { icon: <Workflow className="text-yellow-400 w-6 h-6" />, title: "Sales Pipeline Automation", desc: "Streamline your entire sales funnel from lead capture to deal closure." },
            { icon: <Bot className="text-yellow-400 w-6 h-6" />, title: "Chatbot & Communication", desc: "Engage customers with AI-driven responses, auto-emails, and notifications." },
            { icon: <DatabaseZap className="text-yellow-400 w-6 h-6" />, title: "Data Sync & Management", desc: "Ensure all customer data is accurate, updated, and stored securely." },
            { icon: <UserCheck className="text-yellow-400 w-6 h-6" />, title: "Lead Qualification", desc: "Filter and score leads based on engagement and behavior." },
            { icon: <ShieldCheck className="text-yellow-400 w-6 h-6" />, title: "Security & Compliance", desc: "Implement data policies that keep you compliant with industry regulations." },
            { icon: <Zap className="text-yellow-400 w-6 h-6" />, title: "Workflow Triggers", desc: "Trigger actions like follow-ups, escalations, or status changes automatically." },
          ].map((item, i) => (
      ...
      <div className="bg-[#121b35] p-10 rounded-2xl border border-white/10">
        ...
        <div className="space-y-8">
          {["Business Requirements Analysis", "CRM Tool Selection & Planning", "Workflow Design & Automation Setup", "Data Migration & Integration", "Testing & Staff Training", "Ongoing Optimization & Support"].map(
            (step, i) => (
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[1, 2].map((id) => (
            ...
            >
              ...
              <p className="text-gray-300">
                “Implementing CRM automation with this team revolutionized our operations. We save hours daily and customer satisfaction is at an all-time high.”
              </p>
      ...
      <div className="text-center">
        ...
        <button className="bg-yellow-400 text-black font-semibold py-3 px-6 rounded-full hover:bg-cyan-300 transition">
          Schedule a Demo
        </button>
      </div>
    </section>
