      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="space-y-6 animate-slide-in-left pl-6 md:pl-12">
          ...
          <p className="text-base md:text-lg text-gray-400 leading-relaxed max-w-xl">
            We are a software house specializing in web and mobile application development,
            UI/UX design, branding, and product strategy. From innovative startups to established
            enterprises, we help brands build exceptional digital experiences.
          </p>
          <button className="px-6 py-3 bg-gradient-to-r from-blue-900 to-gray-900 cursor-pointer text-white rounded-full transition font-medium">
            Get in Touch
          </button>
        </div>
