...
import { CheckCircle, Star, Palette, Sparkles } from "lucide-react";
    ...
    <section className="w-full bg-gradient-to-r from-[#070121] to-gray-900 text-white px-6 md:px-16 py-20 space-y-24">
      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { title: "Logo Design", desc: "Unique, timeless logos that reflect your brand identity." },
            { title: "Branding & Identity", desc: "Full brand kits with color palettes, typography, and brand guidelines." },
            { title: "Social Media Posts", desc: "Eye-catching designs for all platforms to boost your online presence." },
            { title: "Brochures & Flyers", desc: "Creative and informative designs for marketing materials." },
            { title: "Posters & Banners", desc: "Large-scale visuals optimized for both digital and print use." },
            { title: "Business Cards", desc: "Professional, clean, and impactful business card designs." }
          ].map((item, i) => (
      ...
      <div>
        ...
        <ol className="space-y-6 border-l-2 border-yellow-400 pl-6">
          {["Requirement Gathering", "Research & Moodboard", "Concept Sketches", "Design Execution", "Feedback & Revisions", "Final Delivery"].map(
            (step, index) => (
