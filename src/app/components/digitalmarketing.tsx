    ...
    <section className="w-full bg-gradient-to-r from-[#070121] to-gray-900 py-20 px-4 md:px-12 text-white">
      <div className="max-w-7xl mx-auto space-y-12">
        <div className="text-center">
          <h2 className="text-yellow-400 text-4xl md:text-5xl font-bold mb-4">Comprehensive Digital Marketing Services</h2>
          <p className="text-gray-300 max-w-3xl mx-auto text-lg">
            Boost your online presence and reach your business goals with our full suite of digital marketing services tailored for your brand.
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {services.map((item, i) => (
            ...
            >
              <div className="flex items-center gap-4 mb-4 text-yellow-400">{item.icon} <h3 className="text-xl font-semibold">{item.title}</h3></div>
